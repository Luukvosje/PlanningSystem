...
namespace Planning.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260704083004_AddAppModules")]
    partial class AddAppModules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Planning.Domain.Entities.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Planning.Domain.Entities.OrganizationInvite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Planning.Domain.Entities.OrganizationModule", b =>
                {
                    b.Property<Guid>("OrganizationId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Planning.Domain.Entities.UserModule", b =>
                {
            ...
            modelBuilder.Entity("Planning.Domain.Entities.User", b =>
                {
                    b.HasOne("Planning.Domain.Entities.Account", null)
                        .WithMany()
