        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "character varying(320)", maxLength: 320, nullable: false),
                    ImportantWorkTimes = table.Column<string>(type: "jsonb", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weekday = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AvailabilityRules_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AvailabilityRules_Users_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilityRules_EmployeeId",
                table: "AvailabilityRules",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_AvailabilityRules_OrganizationId",
                table: "AvailabilityRules",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanningRecords_AssignedUserId",
                table: "PlanningRecords",
                column: "AssignedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PlanningRecords_CustomerId",
                table: "PlanningRecords",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_PlanningRecords_OrganizationId",
                table: "PlanningRecords",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanningRecords_StartUtc",
                table: "PlanningRecords",
                column: "StartUtc");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_AccountId_OrganizationId",
                table: "Users",
