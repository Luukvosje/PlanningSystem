...
const importantLines = computed(() =>
  getImportantGridLines(PREVIEW_DAY_WIDTH, uniqueImportantTimes(props.importantWorkTimes)),
)
...
<template>
  <div class="space-y-2">
    ...
    <p class="text-xs text-muted">
      Belangrijke tijden worden als dikkere lijnen getoond. Bij het plannen van diensten wordt automatisch naar deze tijden gesnapt.
    </p>
  </div>
</template>
