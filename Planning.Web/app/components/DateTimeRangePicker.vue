...
<template>
  <div class="space-y-4">
    ...
    >
      ...
      <span v-if="multiDayLabel" class="text-xs text-muted">
        {{ multiDayLabel }}
      </span>
    </div>
    ...
    <div class="space-y-2">
      ...
      <div class="grid grid-cols-2 gap-2">
        <UFormField label="Tijd" name="startTime">
          <UInputTime
            v-model="startTime"
            :hour-cycle="24"
            :disabled="disabled"
        ...
        <UFormField label="Datum" name="startDate">
          <UInputDate
            v-model="startDate"
            :disabled="disabled"
    ...
    <div class="space-y-2">
      ...
      <div class="grid grid-cols-2 gap-2">
        <UFormField label="Tijd" name="endTime">
          <UInputTime
            v-model="endTime"
            :hour-cycle="24"
            :disabled="disabled"
        ...
        <UFormField label="Datum" name="endDate">
          <UInputDate
            v-model="endDate"
            :disabled="disabled"
            icon="i-lucide-calendar"
    ...
    <div v-if="suggestsNextDay" class="flex items-center justify-between gap-2 rounded-lg border border-warning/30 bg-warning/5 px-3 py-2">
